...
if ($_SESSION["user_data"]["group"] == "admin") {
    ...
    <div class="side-menu">
        ...
        <ul>
            ...
            <li><a href="../product_register.php"><i class="bx bxs-backpack"></i><span>Ingresar producto</span> </a></li>
            <li><a href="../user_register.php"><i class="bx bxs-user"></i><span>Registrar cliente</span> </a></li>
            <li><a href="../logout.php"><i class="bx bx-log-out-circle"></i><span>Logout</span> </a></li>
        </ul>
    </div>';
} else {
    echo '
